...
const quizInfo = {
  mongodbAssociateDeveloper: {
    title: "MongoDB Associate Developer",
    desc: "ドキュメント設計・CRUD・集約パイプライン・インデックス・トランザクション基礎"
  },
  mongodbAssociateDba: {
    title: "MongoDB Associate DBA",
    desc: "レプリカセット・シャーディング・バックアップ・監視・セキュリティ・運用基礎"
  },
  mongodbProfessional: {
    title: "MongoDB Professional",
    desc: "高度な設計・性能最適化・分散構成・障害対応・本番運用設計"
  },
  postgresqlAssociate: {
    title: "PostgreSQL Associate Certification",
    desc: "SQL・型・制約・インデックス・権限・バックアップ・基本運用"
  },
  postgresqlProfessional: {
    title: "PostgreSQL Professional Certification",
    desc: "VACUUM・WAL・レプリケーション・性能分析・高可用性・高度運用"
  }
};
...
if (type === "all") {
  document.title = "MongoDB・PostgreSQL資格クイズ";
  pageTitle.textContent = "MongoDB・PostgreSQL資格クイズ";
  pageDesc.textContent = "5カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.mongodbAssociateDeveloper;
